...
async def parser(html):
    ...
    # 获取网页中的畅销书信息
    book_list = soup.find('ul', "bang_list clearfix bang_list_mode")('li')
...
# 将table转化为pandas中的DataFrame并保存excel文件
df = pd.DataFrame(table, range(500), ['rank', 'name', 'comments', 'author', 'publisher'])
df.to_excel('/Users/dragon/my_code/python/demo1/dangdang.xlsx', index=False, encoding='utf_8_sig')
